 ...
 * 
 * @version 1.1, $Revision: 1.1 $, $Date: 2006/08/03 07:40:07 $
 * 
 * @since 1.1
 *  
 */
class GetRecordsResponseValidator extends ResponseValidator {
     ...
     *      defined for GetRecord in the capabilities
     * </ul>
     ...
     * @param user
     * @see GetFeatureRequestValidator#validateRequest(OGCWebServiceRequest, String)
     */
...
$Log: GetRecordsResponseValidator.java,v $
Revision 1.1  2006/08/03 07:40:07  poth
class renamed from GetRecordResponseValidator to GetRecordsResponseValidator

Revision 1.1  2006/07/23 08:44:53  poth
refactoring - moved validators assigned to OWS into specialized packages

Revision 1.2  2006/05/25 09:53:31  poth
