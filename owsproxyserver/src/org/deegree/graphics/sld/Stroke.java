...
public class Stroke extends Drawing implements Marshallable {
     ...
     *                  <tt>CssParameters</tt>
     */
    protected Stroke( HashMap cssParams, GraphicStroke graphicStroke, 
        ...
        if ( cssParam != null ) {
            ...
            for (int i = 0; i < o.length; i++) {
                ...
                try {
                    ...
                    color = Color.decode( o[i].toString().trim() );
    ...
    */
    public void setStroke (Color stroke)  {
        ...
        CssParameter strokeColor = 
            StyleFactory.createCssParameter( "stroke", ColorUtils.toHexCode( "#", stroke ) );
    ...
    */
     ...
     * <p>
     * @param feature the encoded pattern
...
Revision 1.13  2006/09/28 12:49:28  poth
code formating

Revision 1.12  2006/08/24 20:32:53  poth
bug fix - allow stroke width = 0

Revision 1.11  2006/07/29 08:51:11  poth
references to deprecated classes removed

Revision 1.10  2006/07/14 14:58:10  schmitz
Fixed small parser bug.
