 ...
 *
 * @version 1.0. $Revision: 1.1 $, $Date: 2006/09/19 20:10:43 $
 *
 * @since 2.0
 */
public class TargetMethod {
     ...
     * @param preTrigger may be <code>null</code>
     * @param postTrigger may be <code>null</code>
     */
     ...
     * If no pre trigger is assigned <code>null</code> will be returned
     * @return
     */
     ...
     * If no post trigger is assigned <code>null</code> will be returned
     * @return
     */
...
$Log: TargetMethod.java,v $
Revision 1.1  2006/09/19 20:10:43  poth
initial check in
