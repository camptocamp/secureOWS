 ...
 * @since 2.0
 */
public abstract class DistanceRule extends AbstractClassificationRule {
     ...
     * @param distance
     */
    public DistanceRule( int classId, String description, double[] representativeValue,
