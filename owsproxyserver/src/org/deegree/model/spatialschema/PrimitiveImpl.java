...
/**
* default implementation of the Primitive interface from
* package jago.model. 
*
* ------------------------------------------------------------
* @version 8.6.2001
* @author Andreas Poth 
*/
abstract class PrimitiveImpl extends GeometryImpl implements Primitive, Serializable {
