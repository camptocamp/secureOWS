...
/**
* default implementation of the OrientableSurface interface from
...
* @author Andreas Poth
*/
abstract class OrientableSurfaceImpl extends OrientablePrimitiveImpl
    implements OrientableSurface, Serializable {
     ...
     * @throws GeometryException 
     */
    protected OrientableSurfaceImpl( CoordinateSystem crs, char orientation )
                                 throws GeometryException {
        super( crs, orientation );
    }
} /* ********************************************************************
Changes to this class. What the people have been up to:
$Log: OrientableSurfaceImpl.java,v $
