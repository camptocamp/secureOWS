 ...
 * OperationsMetadata (both XML-Entities & JavaObjects).
...
public class OperationDefines {
    ...
    public static int getTypeByName (String name) {
        ...
        if (operationInfo == null) return TYPE_UNKNOWN;
    ...
    public static int getIdByName (String name) {
        ...
        if (operationInfo == null) return UNKNOWN;
    ...
    public static String getNameById (int id) {
        ...
        OperationInfo operationInfo = (OperationInfo) ids.get (new Integer (id));
        if (operationInfo == null) return null;
