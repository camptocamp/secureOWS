...
@version 1.0. $Revision: 1.6 $, $Date: 2006/08/18 07:48:41 $
...
$Log: wfs2wms.xsl,v $
Revision 1.6  2006/08/18 07:48:41  poth
bug fix - namespace prefix for datasource capabilities OnlinResource added

Revision 1.5  2006/08/06 19:53:18  poth
