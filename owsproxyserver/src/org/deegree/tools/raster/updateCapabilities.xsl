...
@version 1.0. $Revision: 1.4 $, $Date: 2006/12/04 10:00:19 $
		...
		<xsl:element name="wcs:ContentMetadata">
			...
			<CoverageOfferingBrief gml:id="ID000002">
				...
				<xsl:element name="lonLatEnvelope">
					<xsl:attribute name="srsName"><xsl:value-of select="'WGS84(DD)'"/></xsl:attribute>
...
$Log: updateCapabilities.xsl,v $
Revision 1.4  2006/12/04 10:00:19  bezema
delete linebreak in CoverageOfferingBrief file element
