...
public class SDEAdapter {
     ...
     */
    public static Geometry wrap( SeShape shape )
     ...
     * @param shape
     */
    private static Point wrapPoint( SeShape shape )
                            throws SeException {
        ...
        Point point = GeometryFactory.createPoint( xyz[0][0][0], xyz[0][0][1], null );
     ...
     * @param shape
     */
    private static Curve wrapCurve( SeShape shape )
                            throws GeometryException, SeException {
        ...
        Curve curve = GeometryFactory.createCurve( gmSimpleLinePosition, null );
     ...
     * @param shape
     */
    private static Surface wrapSurface( SeShape shape )
                            throws GeometryException, SeException {
     ...
     * @param shape
     */
    private static MultiPoint wrapMultiPoint( SeShape shape )
                            throws SeException {
     ...
     * @param shape
     */
    private static MultiCurve wrapMultiCurve( SeShape shape )
                            throws GeometryException, SeException {
        ...
        for ( int partNo = 0; partNo < numParts; partNo++ ) {
            ...
            for ( int pt = partOffset[partNo]; pt < lastPoint; pt++ ) {
                gmMultiSimpleLinePosition[i] = GeometryFactory.createPosition( points[pt].getX(),
                                                                               points[pt].getY() );
                i++;
            }
     ...
     * @param shape
     */
    private static MultiSurface wrapMultiSurface( SeShape shape )
                            throws GeometryException, SeException {
        ...
        for ( int partNo = 0, partEnd = 0; partNo < partOffset.length; partNo++ ) {
            ...
            for ( ; ( pointNo < points.length ) && ( pointNo < partEnd ); pointNo++ ) {
                ...
                if ( exterior ) {
                    gmMultiPolygonExteriorRing[i] = GeometryFactory.createPosition(
                                                                                    points[pointNo].getX(),
                                                                                    points[pointNo].getY() );
            ...
            gmMultiPolygonSurface[partNo] = GeometryFactory.createSurface(
    ...
    /**
     * Set a row value with the appropriate setting method. If the datatype is unknown it will
     * be assigned by following rules:<br>
     *   - first, check the dataype of the given value and choose an appropriate setter method<br>
     *   - or, if it isn't assignable this way, take the setString method
     *
     * @param row
     * @param pos - the column position (0 - n)
     * @param value - the column value
     * @param sdetype - the datatype, expressed as SeColumnDefinition constant or -1, if unknown
     */
    ...
    public static int mapSDE2SQL( int sdetype ) {
        ...
        case SeColumnDefinition.TYPE_DOUBLE: // Deprecated. at ArcSDE v9.0, replaced by TYPE_FLOAT64
            return java.sql.Types.DOUBLE;
        case SeColumnDefinition.TYPE_FLOAT: // Deprecated. at ArcSDE v9.0, replaced by TYPE_FLOAT32
            return java.sql.Types.FLOAT;
        case SeColumnDefinition.TYPE_INT64: // Since ArcSDE v9.0
            return java.sql.Types.INTEGER;
        case SeColumnDefinition.TYPE_INTEGER: // Deprecated. at ArcSDE v9.0, replaced by TYPE_INT32
            return java.sql.Types.INTEGER;
        case SeColumnDefinition.TYPE_NCLOB:
            return java.sql.Types.CLOB;
        case SeColumnDefinition.TYPE_NSTRING:
        ...
        case SeColumnDefinition.TYPE_SMALLINT: // Deprecated. at ArcSDE v9.0, replaced by TYPE_INT16
 ...
 * $Log: SDEAdapter.java,v $
 * Revision 1.7  2006/05/21 19:12:29  poth
 * several changes required by implemnted SDEDatastore / adapted to ArcSDE 9 java API
 *
 * Revision 1.2  2006/05/09 14:57:02  polli
