...
public class IDGeneratorFactory {
	...
	public static DataBaseIDGenerator createIDGenerator (Connection con, String tableName,
                                                         String fieldName)
		throws SQLException {
		...
		switch (type) {
			...
			default: {
				throw new SQLException (
					"Cannot create DataBaseIDGenerator for table '" + tableName +
					"' and field '" + fieldName + "'. Only integer and alphanumeric " +
