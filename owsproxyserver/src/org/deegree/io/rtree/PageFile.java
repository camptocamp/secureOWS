...
abstract class PageFile implements Serializable {
	 ...
	 * @param int - index of page file number where node is saved
	 * @return Node
	 * @throws PageFileException
	 */
	protected abstract Node readNode(int pageFileNumber) throws PageFileException ;
...
$Log: PageFile.java,v $
Revision 1.6  2006/08/08 09:07:29  poth
*** empty log message ***
