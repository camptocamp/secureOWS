...
/**
 * <p>
 * A persistent implementation of a PageFile implemented based on 
 * a RandomAccesFile.
 * </p>
 * <p>
 ...
 * int pageNumber - own page number<br>
 * - for(i = 0; i < capacity; i++)<br>
 * int data Entry i - page number of childnode or object ID of data entry<br>
 * - always dependend on dimension = x<br>
 * 	double pMin x.Dimension - pMin of the common HyperBoundingBox<br>
 * 	double pMax x.Dimension - pMax of the common HyperBoundingBox<br>
 * 	- for(i = 0; i < capacity; i++)<br>
...
class PersistentPageFile extends PageFile {
	 ...
	 * Overrides initialize in PageFile.
     ...
     */
	protected Node readNode(int pageFileNumber) throws PageFileException {
	...
	private HyperBoundingBox readNextHyperBoundingBox(DataInputStream ds) throws IOException {
     ...
     */
	protected Node deleteNode(int pageNumber) throws PageFileException {
