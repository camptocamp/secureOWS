...
public class AxisDescription extends Description implements Cloneable {
     ...
     * @param values
     */
    public AxisDescription(String name, String label, Values values) 
     ...
     * @param values
     */
    public AxisDescription(String name, String label, String description, MetadataLink metadataLink, 
                           URI semantic, URI refSys, String refSysLabel, Values values)
                           throws OGCException, WCSException {
    ...
    public Object clone() {        
        ...
        try {
            ...
            return new AxisDescription( des.getName(), des.getLabel(), des.getDescription(), 
                                        des.getMetadataLink(),semantic, refSys, 
                                        refSysLabel, values_);
        } catch(Exception e) {}
        return null;
    }
