...
@version 1.0. $Revision: 1.6 $, $Date: 2006/10/27 14:45:57 $
                 
====================================================================================== -->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:deegree="http://www.deegree.org/wms" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:wms="http://www.opengis.net/wms" xmlns:sld="http://www.opengis.net/sld">
    <xsl:variable name="DEFAULTONLINERESOURCE">
        <xsl:value-of select="/wms:WMS_Capabilities/deegree:DeegreeParam/deegree:DefaultOnlineResource/@xlink:href"/>
    </xsl:variable>
    ...
    <xsl:template match="wms:WMS_Capabilities">
        <wms:WMS_Capabilities xmlns:deegree="http://www.deegree.org/wms" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:gml="http://www.opengis.net/gml" xmlns:wfs="http://www.opengis.net/wfs" xmlns:ogc="http://www.opengis.net/ogc">
                    ...
                    <wms:HTTP>
                        <wms:Get>
                            <wms:OnlineResource xmlns:xlink="http://www.w3.org/1999/xlink" xlink:type="simple">
                                <xsl:attribute name="xlink:href"><xsl:value-of select="./wms:GetCapabilities/wms:DCPType/wms:HTTP/wms:Get/wms:OnlineResource/@xlink:href"/></xsl:attribute>
                            </wms:OnlineResource>
                        </wms:Get>
            ...
            <wms:GetMap>
                ...
                <wms:DCPType>
                    <wms:HTTP>
                        <wms:Get>
                            <wms:OnlineResource xmlns:xlink="http://www.w3.org/1999/xlink" xlink:type="simple">
                                <xsl:attribute name="xlink:href"><xsl:value-of select="./wms:GetMap/wms:DCPType/wms:HTTP/wms:Get/wms:OnlineResource/@xlink:href"/></xsl:attribute>
                            </wms:OnlineResource>
                        </wms:Get>
                        <xsl:copy-of select="./wms:GetMap/wms:DCPType/wms:HTTP/wms:Post"/>
                    </wms:HTTP>
                </wms:DCPType>
            </wms:GetMap>
                ...
                <wms:GetFeatureInfo>
                    ...
                    <wms:DCPType>
                        <wms:HTTP>
                            <wms:Get>
                                <wms:OnlineResource xmlns:xlink="http://www.w3.org/1999/xlink" xlink:type="simple">
                                    <xsl:attribute name="xlink:href"><xsl:value-of select="./wms:GetFeatureInfo/wms:DCPType/wms:HTTP/wms:Get/wms:OnlineResource/@xlink:href"/></xsl:attribute>
                                </wms:OnlineResource>
                            </wms:Get>
                ...
                <sld:GetLegendGraphic>
                    ...
                    <wms:DCPType>
                        <wms:HTTP>
                            <wms:Get>
                                <wms:OnlineResource xmlns:xlink="http://www.w3.org/1999/xlink" xlink:type="simple">
                                    <xsl:attribute name="xlink:href"><xsl:value-of select="./sld:GetLegendGraphic/wms:DCPType/wms:HTTP/wms:Get/wms:OnlineResource/@xlink:href"/></xsl:attribute>
                                </wms:OnlineResource>
                            </wms:Get>
                ...
                <sld:GetStyles>
                    ...
                    <wms:DCPType>
                        <wms:HTTP>
                            <wms:Get>
                                <wms:OnlineResource xmlns:xlink="http://www.w3.org/1999/xlink" xlink:type="simple">
                                    <xsl:attribute name="xlink:href"><xsl:value-of select="./sld:GetStyles/wms:DCPType/wms:HTTP/wms:Get/wms:OnlineResource/@xlink:href"/></xsl:attribute>
                                </wms:OnlineResource>
                            </wms:Get>
                ...
                <sld:PutStyles>
                    ...
                    <wms:DCPType>
                        <wms:HTTP>
                            <wms:Get>
                                <wms:OnlineResource xmlns:xlink="http://www.w3.org/1999/xlink" xlink:type="simple">
                                    <xsl:attribute name="xlink:href"><xsl:value-of select="./sld:PutStyles/wms:DCPType/wms:HTTP/wms:Get/wms:OnlineResource/@xlink:href"/></xsl:attribute>
                                </wms:OnlineResource>
                            </wms:Get>
...
<!--                     <xsl:otherwise>
    ...
    <xsl:template match="wms:Style" name="wms:Style">
        ...
        <wms:Style>
                        ...
                        <wms:OnlineResource xlink:type="simple">
                            <xsl:choose>
                        		<xsl:when test="boolean(./../Name)">
                            		<xsl:attribute name="xlink:href"><xsl:value-of select="$DEFAULTONLINERESOURCE"/>?request=GetLegendGraphic&amp;version=<xsl:value-of select="$VERSION"/>&amp;width=10&amp;height=10&amp;format=image/gif&amp;layer=<xsl:value-of select="./../wms:Name"/>&amp;style=<xsl:value-of select="$STYLENAME"/></xsl:attribute>
                           		</xsl:when>
                           		<xsl:otherwise>
                           			<xsl:attribute name="xlink:href"><xsl:value-of select="$DEFAULTONLINERESOURCE"/>?request=GetLegendGraphic&amp;version=<xsl:value-of select="$VERSION"/>&amp;width=10&amp;height=10&amp;format=image/gif&amp;layer=<xsl:value-of select="./wms:Name"/>&amp;style=<xsl:value-of select="$STYLENAME"/></xsl:attribute>
                           		</xsl:otherwise>
            ...
            <xsl:copy-of select="$pStyle/wms:StyleSheetURL"/>
            <xsl:copy-of select="$pStyle/wms:StyleURL"/>
...
$Log: WMSConfigurationTransform_1_3_0.xsl,v $
Revision 1.6  2006/10/27 14:45:57  schmitz
...
Revision 1.5  2006/10/27 09:52:23  schmitz
...
Revision 1.3  2006/10/20 16:28:59  poth
bug fix - creating default LegendURL

Revision 1.2  2006/10/10 13:46:02  schmitz
