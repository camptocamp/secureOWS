//$Header: /home/deegree/jail/deegreerepository/deegree/src/org/deegree/ogcwebservices/wmps/XMLFactory.java,v 1.24 2006/08/23 10:21:12 deshmukh Exp $
/*----------------    FILE HEADER  ------------------------------------------
...
public class XMLFactory extends org.deegree.owscommon.XMLFactory {
    ...
    public static WMPSCapabilitiesDocument export( WMPSCapabilities capabilities )
        ...
        try {
            ...
            appendCapabilityRequests( root,
                                      (WMPSOperationsMetadata) capabilities.getOperationMetadata() );
    ...
    protected static void appendService( Element root, ServiceIdentification identification,
        ...
        if ( identification.getAccessConstraints().length > 0 ) {
            XMLTools.appendElement( root, null, "AccessConstraints",
                                    identification.getAccessConstraints()[0] );
        } else {
    ...
    private static void appendExpectedTime( Element root, Date expectedTime )
        ...
        try {
            ...
            throw new XMLParsingException( "Error getting node "
                                           + "'deegreewmps:expectedProcessingTime'. "
                                           + "Please check the WMPSInitialResponseTemplate "
                                           + "to confirm its presence." );
 ...
 * Changes to this class. What the people have been up to: Revision 1.24  2006/08/23 10:21:12  deshmukh
 * Changes to this class. What the people have been up to: detailed response messages in case of exception added.
 * Changes to this class. What the people have been up to: Changes to this
 * class. What the people have been up to: Revision 1.23 2006/08/10 07:11:35 deshmukh Changes to
 * this class. What the people have been up to: WMPS has been modified to support the new
 * configuration changes and the excess code not needed has been replaced. Changes to this class.
 * What the people have been up to: Changes to this class. What the people have been up to: Revision
 * 1.22 2006/08/01 13:41:47 deshmukh Changes to this class. What the people have been up to: The
 * wmps configuration has been modified and extended. Also fixed the javadoc. Changes to this class.
 * What the people have been up to: Revision 1.21 2006/07/20 13:24:12 deshmukh Removed a few
 * floating bugs.
 * 
 * Revision 1.20 2006/07/12 14:46:16 poth comment footer added
 * 
 **************************************************************************************************/
