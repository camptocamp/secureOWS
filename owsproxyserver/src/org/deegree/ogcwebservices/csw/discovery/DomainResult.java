...
/**
 * @author <a href="mailto:poth@lat-lon.de">Andreas Poth </a> * @author <a href="mailto:tfr@users.sourceforge.net">Torsten Friebe </a> *  * @author last edited by: $Author: poth $ *  * @version 2.0, $Revision: 1.9 $, $Date: 2006/10/18 17:00:55 $
 */
...
$Log: DomainResult.java,v $
Revision 1.9  2006/10/18 17:00:55  poth
made DefaultOGCWebServiceResponse base type for all webservice responses

Revision 1.8  2006/08/08 09:21:22  poth
return domain values (empty at the moment)
