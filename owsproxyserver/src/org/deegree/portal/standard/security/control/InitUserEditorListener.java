...
/**
 * This <code>Listener</code> reacts on 'initUserEditor' events, queries the
 * <code>SecurityManager</code> and passes the group data on to be displayed
 * by the JSP.
 * <p>
    ...
    public void actionPerformed(FormEvent event) {
        ...
        try {
            ...
            getRequest()
                    .setAttribute(
                            "MESSAGE",
                            "Der Benutzereditor konnte nicht "
...
$Log: InitUserEditorListener.java,v $
