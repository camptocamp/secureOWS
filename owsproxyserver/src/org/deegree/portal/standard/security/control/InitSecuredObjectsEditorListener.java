...
/**
 * This <code>Listener</code> reacts on 'initSecuredObjectEditor' events and
 * passes the <code>SecuredObjects</code> (Layers / FeatureTypes) to be displayed
 * on the JSP.
 * 
 * Access constraints:
 * <ul>
...
public class InitSecuredObjectsEditorListener extends AbstractListener {
    ...
    public void actionPerformed(FormEvent event) {
        ...
        try {
            ...
            getRequest().setAttribute( "MESSAGE", "Der Layer-/FeatureType-Editor konnte nicht "
...
$Log: InitSecuredObjectsEditorListener.java,v $
