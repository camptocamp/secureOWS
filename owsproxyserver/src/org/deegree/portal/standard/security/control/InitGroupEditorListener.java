...
/**
 * This <code>Listener</code> reacts on 'initGroupAdministration' events, queries
 * the <code>SecurityManager</code> and passes the group data on to be displayed
 * by the JSP.
 *
 * Access constraints:
 * <ul>
    ...
    public void actionPerformed(FormEvent event) {
        ...
        try {
            ...
            getRequest()
                    .setAttribute(
                            "MESSAGE",
                            "Die Gruppenadministration konnte nicht "
...
$Log: InitGroupEditorListener.java,v $
